package com.wy.lpr.expresslove.utils.bluesnow;
...
import com.wy.lpr.expresslove.utils.DeviceInfo;
...
public class FlowerView extends View {
    ...
    class MyFlower {
        ...
        public void init() {
            ...
            this.g = FlowerView.this.offsetY[FlowerView.this.r.nextInt(4)];
        }
    ...
    public void setWH(int pW, int pH, float de) {
        ...
        this.offsetY = new Integer[]{(int) (3.0f * de), (int) (5.0f * de), (int) (5.0f * de),
                (int) (3.0f * de), (int) (4.0f * de)};
    }
    ...
    public void loadFlower() {
        Observable.just(R.mipmap.snow2)
                .map(new Func1<Integer, Bitmap>() {
                    public Bitmap call(Integer integer) {
                        return ((BitmapDrawable) FlowerView.this.getResources().getDrawable(integer)).getBitmap();
                    }
