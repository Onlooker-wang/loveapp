...
public class AvatarImageView extends AppCompatImageView {
    ...
    private void initClickListener() {
        super.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOriginUri != null) {
                    afterCropListener.onClick(mOriginUri, 0);
                } else {
                    afterCropListener.onClick(null, R.drawable.music_bg8);
                }
    ...
    public void setHeadLayoutListener() {
        startActionPickCrop();
    }
            ...
            case AvatarImageView.REQUEST_IMAGE_BY_SDCARD:
                ...
                if (data != null) {
                    ...
                    if (uri != null) {
                        ...
                        //将裁剪后的uri保存
                        SharedPreferencesUtils.putString(mContext, Constant.HEAD_IMAGE_URI_SP, Constant.HEAD_IMAGE_CROP_URI, Uri.fromFile(absolutePicFile).toString());
                    }
                }
                break;
    ...
    public interface AfterCropListener {
        ...
        //图片点击事件
        void onClick(Uri uri, int resId);
    }
