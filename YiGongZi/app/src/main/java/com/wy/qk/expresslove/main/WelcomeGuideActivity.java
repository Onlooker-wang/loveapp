...
import com.wy.qk.expresslove.adapter.GuideViewPagerAdapter;
 ...
 * 
 */
public class WelcomeGuideActivity extends CommonAudioActivity implements OnClickListener {
	...
	protected void onPause() {
		...
		SpUtils.putBoolean(WelcomeGuideActivity.this, MyApplication.FIRST_OPEN, true);
		finish();
	}
